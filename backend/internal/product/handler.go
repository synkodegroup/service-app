...
func (h *Handler) List(c *gin.Context) {
    ...
    res, _ := h.svc.List(ListParams{ Page: page, PageSize: pageSize, Search: search, Status: status, SortBy: sortBy, SortDir: sortDir })
...
type productInput struct { Name string `json:"name"`; Price float64 `json:"price"`; Stock int `json:"stock"`; Status Status `json:"status"` }
